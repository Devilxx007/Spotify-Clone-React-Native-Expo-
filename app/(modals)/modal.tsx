      ...
      <SafeAreaView>
        <View className=" flex flex-row items-center px-1">
          ...
          <View className=" flex-1">
            <Text className=" text-white text-[20px] font-bold text-center">{currentTrack?.track?.name}</Text>
          </View>
          <TouchableOpacity>
        ...
        <View className=" p-3">
          <Image className=" rounded-sm w-[100%] h-[330px]" source={{uri:currentTrack?.track?.album?.images[0]?.url}}/>
        </View>
        <View className=" flex flex-row justify-between items-center">
        <View className=" flex-1 gap-1 ml-2">
          <Text className=" text-xl font-bold text-white">{currentTrack?.track?.name}</Text>
          <Text className=" text-[15px] font-bold text-[#D3D3D3]">{currentTrack?.track?.artists[0]?.name}</Text>
        </View>
